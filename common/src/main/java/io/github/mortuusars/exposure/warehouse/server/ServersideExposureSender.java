...
public class ServersideExposureSender {
    ...
    public synchronized void sendTo(String exposureId, ExposureData exposureData, @NotNull ServerPlayer receivingPlayer) {
        ...
        for (int i = 0; i < parts.length; i++) {
            ExposureDataPartS2CP packet = new ExposureDataPartS2CP(exposureId, parts[i], i == parts.length - 1);
