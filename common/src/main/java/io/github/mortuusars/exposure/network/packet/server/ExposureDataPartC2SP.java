...
public record ExposureDataPartC2SP(String exposureId, byte[] partBytes, boolean isLast) implements IPacket {
    ...
    public static final StreamCodec<FriendlyByteBuf, ExposureDataPartC2SP> STREAM_CODEC = StreamCodec.composite(
            ByteBufCodecs.STRING_UTF8, ExposureDataPartC2SP::exposureId,
    ...
    public boolean handle(PacketFlow flow, Player player) {
        ExposureServer.exposureReceiver().receivePart(exposureId, partBytes, isLast);
        return true;
    }
}
