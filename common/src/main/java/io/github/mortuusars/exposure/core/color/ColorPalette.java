...
public record ColorPalette(int[] colors) {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, Holder<ColorPalette>> STREAM_CODEC = ByteBufCodecs.holder(Exposure.Registries.COLOR_PALETTE, DIRECT_STREAM_CODEC);
