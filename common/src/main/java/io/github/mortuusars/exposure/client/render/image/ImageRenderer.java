...
public class ImageRenderer implements AutoCloseable {
    ...
    public void render(PoseStack poseStack, MultiBufferSource bufferSource, IdentifiableImage image) {
        this.render(poseStack, bufferSource, image, RenderCoordinates.DEFAULT, LightTexture.FULL_BRIGHT, Color.WHITE);
    }

    public void render(PoseStack poseStack, MultiBufferSource bufferSource, IdentifiableImage image, int packedLight) {
        this.render(poseStack, bufferSource, image, RenderCoordinates.DEFAULT, packedLight, Color.WHITE);
    }

    public void render(PoseStack poseStack, MultiBufferSource bufferSource, IdentifiableImage image, RenderCoordinates coords, Color color) {
        this.render(poseStack, bufferSource, image, coords, LightTexture.FULL_BRIGHT, color);
    }

    public void render(PoseStack poseStack, MultiBufferSource bufferSource, IdentifiableImage image, RenderCoordinates coords,
