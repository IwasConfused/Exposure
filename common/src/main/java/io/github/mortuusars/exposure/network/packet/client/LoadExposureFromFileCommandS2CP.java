...
public record LoadExposureFromFileCommandS2CP(String exposureId, String filePath, int size, boolean dither) implements IPacket {
    ...
    public static final StreamCodec<FriendlyByteBuf, LoadExposureFromFileCommandS2CP> STREAM_CODEC = StreamCodec.composite(
            ByteBufCodecs.STRING_UTF8, LoadExposureFromFileCommandS2CP::exposureId,
    ...
    public boolean handle(PacketFlow direction, Player player) {
        ClientPacketsHandler.loadExposure(exposureId, filePath, size, dither);
        return true;
    }
}
