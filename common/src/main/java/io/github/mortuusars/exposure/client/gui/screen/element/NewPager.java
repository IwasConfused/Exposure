...
public class NewPager {
    ...
    public NewPager setPagesCount(int pages) {
    ...
    public NewPager setCycled(boolean cycled) {
        this.cycle = cycled;
        return this;
    }
    ...
    public NewPager setChangeCooldown(int milliseconds) {
    ...
    public NewPager setChangeSound(@Nullable SoundEffect changeSound) {
    ...
    public NewPager setPreviousPageButton(@Nullable AbstractButton previousPageButton) {
    ...
    public NewPager setNextPageButton(@Nullable AbstractButton nextPageButton) {
    ...
    public NewPager onPageChanged(OnPageChanged onPageChanged) {
    ...
    public void playChangeSound() {
        getChangeSound().ifPresent(sound -> Minecrft.get().getSoundManager().play(
                SimpleSoundInstance.forUI(sound.get(), sound.volume(), sound.getFinalPitch())));
    }
