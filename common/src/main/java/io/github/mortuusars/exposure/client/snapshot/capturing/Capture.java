...
public class Capture extends Task<Result<Image>> {
    ...
    public Capture(CaptureMethod captureMethod, CaptureComponent component, long timeoutMs, Consumer<TranslatableError> onError) {
