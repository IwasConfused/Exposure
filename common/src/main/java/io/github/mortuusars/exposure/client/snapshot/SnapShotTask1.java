...
public class SnapShotTask1 {
    ...
    public SnapShotTask1(@NotNull CaptureTask captor) {
    ...
    public SnapShotTask1 consume(Consumer<CompletableFuture<Image>> resultConsumer) {
